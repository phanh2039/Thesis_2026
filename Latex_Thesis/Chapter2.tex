...
\begin{table}[htbp]
\caption{Missingness in variables used for adjusted models}
\centering
\small
...
\hline
HPV vaccine awareness & 0 & 0.0 \\
Any-dose HPV vaccine uptake & 0 & 0.0 \\
Age group, residence, ethnicity, education, wealth quintile, mass media exposure & 0 & 0.0 \\
Health insurance & 1 & $<$0.1 \\
Marital status & 1 & $<$0.1 \\
Ever had sexual intercourse & 1 & $<$0.1 \\
Gender-equitable attitude proxy & 201 & 4.9 \\
\hline
\multicolumn{3}{|p{11.5cm}|}{\footnotesize The final analytic sample contained 4,102 women. Complete-case adjusted models for full-sample outcomes used 3,899 observations. Among 2,133 aware women, 2,064 had complete covariate information for the gap and vaccination-among-aware analyses.} \\
\hline
\end{tabular}
